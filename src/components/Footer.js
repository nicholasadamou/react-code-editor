...
const Footer = () => (
	<div className='h-8 mb-2 px-2 py-1 flex items-center justify-center w-full text-xs text-white'>
		<span>
			Built with{" "}
			<svg
				height='2500'
			...
			<a
				...
				target='__blank'
				className='text-white hover:bg-[#ea4a5a] hover:text-white font-medium'
			>
				Nicholas Adamou
			</a>
			. Code at{" "}
			<a
				href='https://github.com/nicholasadamou/react-code-editor'
				target='__blank'
				className='text-white hover:bg-[#ea4a5a] hover:text-white font-medium'
			>
				GitHub
